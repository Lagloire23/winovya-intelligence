...
import { X, Search, Loader2, Mail, Phone, Globe, MapPin, Sparkles } from 'lucide-react'
...
function EluCard({ elu, contact }: EluCardData) {
  return (
    <div className="card-winovya p-3">
      ...
      <div className="mt-2 pt-2 border-t border-[hsl(217,6%,90%)] space-y-1.5">
...
export function EluSearchModal({ onClose }: Props) {
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-[hsl(217,6%,90%)] shrink-0">
          <h2 className="font-heading font-bold text-brand-navy flex items-center gap-2">
            <Search size={16} /> Trouver le maire ou élu(e) d'une commune
          </h2>
